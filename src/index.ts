...
export function scope(tableSchema: TableSchema): ScopedDynameh {
    return {
        requestBuilder: {
            ...
            buildConditionalPutInput: (item, ...conditions) => requestBuilder.buildConditionalPutInput(tableSchema, item, ...conditions),
            ...
            buildConditionalDeleteInput: (itemToDelete, ...conditions) => requestBuilder.buildConditionalDeleteInput(tableSchema, itemToDelete, ...conditions),
